...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  ImageProvider<Object>? _getAvatarImage() {
    ...
    if (_avatarUrl != null) {
      if (_avatarUrl!.startsWith('asset:')) {
        return AssetImage(_avatarUrl!.substring(6));
      }
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: const Text('Avatar Kartun'),
                onTap: () {
                  Navigator.pop(context);
                  _showEmojiPickerDialog();
                },
              ),
              if (_avatarUrl != null || _avatarImageFile != null)
                ListTile(
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return Container(
          ...
          child: Column(
            children: [
              const Text("Pilih Avatar Kartun", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        setState(() {
                          _avatarUrl = 'asset:$assetPath';
                          _avatarImageFile = null;
                          _isAvatarMarkedForDeletion = false;
                        });
                        Navigator.pop(context);
                      },
                    ...
                    Positioned(
                      ...
                      child: CircleAvatar(
                        ...
                        child: IconButton(
                          ...
                          onPressed: _showImageSourceDialog, // Tombol Edit (pensil)
                          tooltip: 'Ganti Foto',
                        ),
                      ),
                    ),
